            ...
            return e = i, (t = [{
                ...
                value: function(t) {
                    ...
                    a.videoImage ? t(a.videoImage) : ("youtube" === a.type && (e = ["maxresdefault", "sddefault", "hqdefault", "0"], o = 0, (i = new Image).onload = function() {
                        120 !== (this.naturalWidth || this.width) || o === e.length - 1 ? (a.videoImage = "https://img.youtube.com/vi/".concat(a.videoID, "../index.php").concat(e[o], ".jpg"), t(a.videoImage)) : (o += 1, this.src = "https://img.youtube.com/vi/".concat(a.videoID, "../index.php").concat(e[o], ".jpg"))
                    }, i.src = "https://img.youtube.com/vi/".concat(a.videoID, "../index.php").concat(e[o], ".jpg")), "vimeo" === a.type && ((n = new XMLHttpRequest).open("GET.html", "https://vimeo.com/api/v2/video/".concat(a.videoID, ".json"), !0), n.onreadystatechange = function() {
                        var e;
